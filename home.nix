...
in {
  ...
  home.sessionVariables = {
    ...
    # -W 1.0 makes bemenu full width (matching waybar).
    BEMENU_OPTS = "--tb=${palette.base01} --tf=${palette.base05} --fb=${palette.base01} --ff=${palette.base05} --nb=${palette.base01} --nf=${palette.base05} --hb=${palette.base03} --hf=${palette.base0A} --sb=${palette.base03} --sf=${palette.base0B} --scb=${palette.base00} --scf=${palette.base03} -W 1.0 -M 2";
  };
...
BEMENU_OPTS="--tb=#''${colors[1]} --tf=#''${colors[5]} --fb=#''${colors[1]} --ff=#''${colors[5]} --nb=#''${colors[1]} --nf=#''${colors[5]} --hb=#''${colors[3]} --hf=#''${colors[10]} --sb=#''${colors[3]} --sf=#''${colors[11]} --scb=#''${colors[0]} --scf=#''${colors[3]} -W 1.0 -M 2"
BEMENU_EOF
